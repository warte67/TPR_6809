...
private:
	...
	const int pixel_width = 256;	// 128;
	const int pixel_height = 160;	// 80;
...
Already Implemented:
	GFX_EXT_ADDR		// (Word) 40K extended graphics addresses (doesnt consider buffer page)
	GFX_EXT_DATA		// (Byte) 40K extended graphics RAM data  (doesnt consider buffer page)
...
Future Implementation:
	...
	GFX_BG_CMD			// (Byte) Commands to be issued on the 20k indexed bitmap buffer
		...
		some potential future commands:
